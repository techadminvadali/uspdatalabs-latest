    ...
    background: (
      <div className="flex justify-center content-center h-full w-full">
        <div className="m-auto p-6 md:p-8 z-10">
          <div className="text-xl md:text-2xl font-medium text-black text-center">
            <div className="flex items-center justify-center mb-2">
              <Boxes className="w-6 h-6 md:w-8 md:h-8 text-orange-500" />
            </div>
            <span className="bg-gradient-to-r from-orange-600 to-amber-500 bg-clip-text text-transparent">
              One Unified 
              <br />
    ...
    <div className="bg-gray-50 py-12 md:py-20 w-full grid overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-8 w-full">
        ...
        >
          ...
          <div className="inline-flex items-center px-3 md:px-4 py-1.5 md:py-2 rounded-full bg-orange-50 border border-orange-200 mb-4 md:mb-6">
            <Zap className="w-4 h-4 md:w-5 md:h-5 text-orange-600 mr-2" />
            <span className="text-sm md:text-base text-orange-700 font-medium">Built for This Moment</span>
          </div>
