...
export default function Header() {
  ...
  return (
    <header className="bg-white w-full max-w-7xl m-auto flex justify-between items-center py-4 md:py-6 border border-gray-200 rounded-xl px-4 md:px-8 mt-5 shadow-sm relative">
      {/* Logo */}
      <h1 className={`${DM_Sans.className} text-xl md:text-2xl font-semibold bg-gradient-to-r from-orange-600 via-amber-500 to-yellow-500 bg-clip-text text-transparent`}>
        <Link href="/">USP DataLabs</Link>
      </h1>
      ...
      <nav className="hidden lg:flex items-center space-x-6">
        ...
        <Link href="/contact">
          <Button className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white px-6 py-2 rounded-lg font-medium">
            Talk to Us
          </Button>
        </Link>
      </nav>
        ...
        <div className="absolute top-full left-0 right-0 mt-2 mx-4 bg-white border border-gray-200 rounded-xl shadow-lg lg:hidden z-50">
          <nav className="flex flex-col p-4 space-y-2">
            ...
            <Link href="/contact" onClick={closeMobileMenu}>
              <Button className="w-full bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white px-6 py-2 rounded-lg font-medium mt-2">
                Talk to Us
              </Button>
            </Link>
          </nav>
