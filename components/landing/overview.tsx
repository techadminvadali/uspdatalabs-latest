  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -left-40 -top-50  opacity-1">
          <img 
            src="/line1.svg" 
            alt="" 
        ...
        <div className="absolute -right-40 -top-50 opacity-1">
          <img 
            src="/line1.svg" 
            alt="" 
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-full max-w-6xl h-[80vh] opacity-5">
      ...
      >
        ...
        <div className="space-y-6">
          <h1 className="text-6xl md:text-7xl font-bold tracking-tight leading-tight min-h-32">
            <TypeAnimation
          ...
          {/* Sub-headline */}
          <p className={`text-xl md:text-2xl text-gray-600 leading-relaxed max-w-4xl mx-auto ${DM_Sans.className}`}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
          ...
          <Button variant="outline" className="px-8 py-4 text-lg border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold rounded-lg shadow-lg">
            See the Platform
          </Button>
        </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl border border-gray-100">
            <div className="aspect-video bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl flex items-center justify-center">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Platform Demo</h3>
                <p className="text-gray-600">See USP DataLabs in action</p>
              </div>
            </div>
          </div>
        </div>
